...
class BandsControllerTest < ActionController::TestCase
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post :create, band: { Band_type_id: @band.Band_type_id, color: @band.color, user_id: @band.user_id }
    end
  ...
  test "should update band" do
    patch :update, id: @band, band: { Band_type_id: @band.Band_type_id, color: @band.color, user_id: @band.user_id }
    assert_redirected_to band_path(assigns(:band))
  end
