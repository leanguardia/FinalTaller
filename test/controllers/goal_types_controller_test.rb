...
class GoalTypesControllerTest < ActionController::TestCase
  ...
  #     post :create, goal_type: { typename: @goal_type.typename, unit_measured: @goal_type.unit_measured }
  #   end
  #
  ...
  #   patch :update, id: @goal_type, goal_type: { typename: @goal_type.typename, unit_measured: @goal_type.unit_measured }
  #   assert_redirected_to goal_type_path(assigns(:goal_type))
  # end
